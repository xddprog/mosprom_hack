...
from backend.api.v1.routers.client.university import router as university_router
...
client_v1_router.include_router(university_router, tags=['client'], prefix='/university')